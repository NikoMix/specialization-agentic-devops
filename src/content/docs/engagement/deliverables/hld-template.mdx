...
3. For each reference architecture in scope (see [Reference Architectures](../../reference-architectures/)), copy the relevant section into the HLD body.
...
<Aside type="tip" title="Download the workfile">
  <a href={`${import.meta.env.BASE_URL}templates/deliverables/hld-template.docx`}>📄 Download the HLD template (DOCX)</a>
</Aside>
